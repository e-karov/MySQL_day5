...
if (isset($_POST["submit"])) {
    ...
    if ($pictureArray->error === 0) {
        ...
        $sql = "UPDATE users SET first_name = '$f_name', last_name = '$l_name', email = '$email', birthdate = '$date_of_birth', picture = '$pictureArray->fileName' WHERE id = {$id}";
    } else {
        $sql = "UPDATE users SET first_name = '$f_name', last_name = '$l_name', email = '$email', birthdate = '$date_of_birth' WHERE id = {$id}";
    }
    ...
    <div class="container">
        ...
        <form method="post" enctype="multipart/form-data">
            <table class="table">
                ...
                <tr>
                    <th>Date of birth</th>
                    <td><input class="form-control" type="date" name="birthdate" placeholder="Date of birth" value="<?php echo $date_birth ?>" /></td>
                </tr>
                <tr>
                    <th>Picture</th>
